...
namespace Test
{
    ...
    int BasicTutorial03(Options options)
    {
        CustomData data;
        GstBus* bus;
        GstMessage* msg;
        ...
        if (!data.source || !data.convert || !data.resample || !data.sink) {
        ...
        gst_bin_add_many(GST_BIN(data.pipeline.Handler()), data.source, data.convert,
        ...
        /* Listen to the bus */
        bus = gst_element_get_bus(data.pipeline.Handler());
        do {
            ...
            if (msg != NULL) {
                ...
                case GST_MESSAGE_STATE_CHANGED:
                    ...
                    if (GST_MESSAGE_SRC(msg) == GST_OBJECT(data.pipeline.Handler())) {
